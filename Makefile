...
SOURCES = $(SRC_DIR)/escreen.c $(SRC_DIR)/selection.c $(SRC_DIR)/freeze.c $(SRC_DIR)/image.c $(SRC_DIR)/clipboard.c \
          $(SRC_DIR)/tool_brush.cpp $(SRC_DIR)/tool_blur.cpp $(SRC_DIR)/tool_line.cpp $(SRC_DIR)/tool_rect.cpp $(SRC_DIR)/tool_arrow.cpp $(SRC_DIR)/tool_stamp.cpp \
...
OBJECTS = $(BUILD_DIR)/escreen.o $(BUILD_DIR)/selection.o $(BUILD_DIR)/freeze.o $(BUILD_DIR)/image.o $(BUILD_DIR)/clipboard.o $(BUILD_DIR)/config.o \
          $(BUILD_DIR)/tool_brush.o $(BUILD_DIR)/tool_blur.o $(BUILD_DIR)/tool_line.o $(BUILD_DIR)/tool_rect.o $(BUILD_DIR)/tool_arrow.o $(BUILD_DIR)/tool_stamp.o \
